...
export const WhatWeDo: React.FC<WhatWeDoProps> = ({ content, onOpenPlanner }) => {
  ...
  return (
    <section id="services" aria-labelledby="services-heading" className="bg-[#F7F9FC] py-20 md:py-28 text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 id="services-heading" className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mt-3 font-heading leading-tight">
            {content.title}
          </h2>
